...
void compareAbsIsolation(TString strSelection="GenMatched"){
  gStyle->SetOptStat(0);

  constexpr float xmultiplier=10.f;
  ...
  TFile* foutput = TFile::Open(Form("muon_%s_absiso_plots.root", strSelectionLower.Data()), "recreate");
  ...
  for (unsigned int is=0; is<nSamples; is++){
    ...
    addByLowest(binarray, 0.f*xmultiplier, true);
    addByLowest(binarray, 0.02f*xmultiplier, true);
    addByLowest(binarray, 100.f*xmultiplier, true);
    for (unsigned int ix=1; ix<=100; ix++) addByLowest(binarray, float(0.05)*xmultiplier*float(ix), true);
    for (unsigned int ix=1; ix<=50; ix++) addByLowest(binarray, float(0.1)*xmultiplier*float(ix)+5.f, true);
    for (unsigned int ix=1; ix<=90; ix++) addByLowest(binarray, float(1.)*xmultiplier*float(ix)+10.f, true);
    for (unsigned int ix=1; ix<=180; ix++) addByLowest(binarray, float(5.)*xmultiplier*float(ix)+100.f, true);
    ...
    for (int ev=0; ev<nEntries; ev++){
      ...
      for (unsigned int imuon=0; imuon<muon_pt->size(); imuon++){
        ...
        if (
          ...
          h_muon_isosumtrackpt_vtx3D_associationrank_0.Fill(muon_isosumtrackpt_vtx3D_associationrank_0->at(imuon));
          h_muon_isosumtrackpt_vtx3D_associationrank_1.Fill(muon_isosumtrackpt_vtx3D_associationrank_0->at(imuon)+muon_isosumtrackpt_vtx3D_associationrank_1->at(imuon));
          h_muon_isosumtrackpt_vtx3D_unassociated.Fill(muon_isosumtrackpt_vtx3D_associationrank_0->at(imuon)+muon_isosumtrackpt_vtx3D_associationrank_1->at(imuon)+muon_isosumtrackpt_vtx3D_unassociated->at(imuon));

          h_muon_isosumtrackpt_vtx3D_nodzcut_associationrank_0.Fill(muon_isosumtrackpt_vtx3D_nodzcut_associationrank_0->at(imuon));
          h_muon_isosumtrackpt_vtx3D_nodzcut_associationrank_1.Fill(muon_isosumtrackpt_vtx3D_nodzcut_associationrank_0->at(imuon)+muon_isosumtrackpt_vtx3D_nodzcut_associationrank_1->at(imuon));
          h_muon_isosumtrackpt_vtx3D_nodzcut_unassociated.Fill(muon_isosumtrackpt_vtx3D_nodzcut_associationrank_0->at(imuon)+muon_isosumtrackpt_vtx3D_nodzcut_associationrank_1->at(imuon)+muon_isosumtrackpt_vtx3D_nodzcut_unassociated->at(imuon));

          h_muon_isosumtrackpt_vtx3D_sipcut_associationrank_0.Fill(muon_isosumtrackpt_vtx3D_sipcut_associationrank_0->at(imuon));
          h_muon_isosumtrackpt_vtx3D_sipcut_associationrank_1.Fill(muon_isosumtrackpt_vtx3D_sipcut_associationrank_0->at(imuon)+muon_isosumtrackpt_vtx3D_sipcut_associationrank_1->at(imuon));
          h_muon_isosumtrackpt_vtx3D_sipcut_unassociated.Fill(muon_isosumtrackpt_vtx3D_sipcut_associationrank_0->at(imuon)+muon_isosumtrackpt_vtx3D_sipcut_associationrank_1->at(imuon)+muon_isosumtrackpt_vtx3D_sipcut_unassociated->at(imuon));

          h_muon_isosumtrackpt_vtx3D_dtmuoncut_associationrank_0.Fill(muon_isosumtrackpt_vtx3D_dtmuoncut_associationrank_0->at(imuon));
          h_muon_isosumtrackpt_vtx3D_dtmuoncut_associationrank_1.Fill(muon_isosumtrackpt_vtx3D_dtmuoncut_associationrank_0->at(imuon)+muon_isosumtrackpt_vtx3D_dtmuoncut_associationrank_1->at(imuon));
          h_muon_isosumtrackpt_vtx3D_dtmuoncut_unassociated.Fill(muon_isosumtrackpt_vtx3D_dtmuoncut_associationrank_0->at(imuon)+muon_isosumtrackpt_vtx3D_dtmuoncut_associationrank_1->at(imuon)+muon_isosumtrackpt_vtx3D_dtmuoncut_unassociated->at(imuon));

          h_muon_isosumtrackpt_vtx3D_dtmuoncut_nodzcut_associationrank_0.Fill(muon_isosumtrackpt_vtx3D_dtmuoncut_nodzcut_associationrank_0->at(imuon));
          h_muon_isosumtrackpt_vtx3D_dtmuoncut_nodzcut_associationrank_1.Fill(muon_isosumtrackpt_vtx3D_dtmuoncut_nodzcut_associationrank_0->at(imuon)+muon_isosumtrackpt_vtx3D_dtmuoncut_nodzcut_associationrank_1->at(imuon));
          h_muon_isosumtrackpt_vtx3D_dtmuoncut_nodzcut_unassociated.Fill(muon_isosumtrackpt_vtx3D_dtmuoncut_nodzcut_associationrank_0->at(imuon)+muon_isosumtrackpt_vtx3D_dtmuoncut_nodzcut_associationrank_1->at(imuon)+muon_isosumtrackpt_vtx3D_dtmuoncut_nodzcut_unassociated->at(imuon));

          h_muon_isosumtrackpt_vtx3D_dtmuoncut_sipcut_associationrank_0.Fill(muon_isosumtrackpt_vtx3D_dtmuoncut_sipcut_associationrank_0->at(imuon));
          h_muon_isosumtrackpt_vtx3D_dtmuoncut_sipcut_associationrank_1.Fill(muon_isosumtrackpt_vtx3D_dtmuoncut_sipcut_associationrank_0->at(imuon)+muon_isosumtrackpt_vtx3D_dtmuoncut_sipcut_associationrank_1->at(imuon));
          h_muon_isosumtrackpt_vtx3D_dtmuoncut_sipcut_unassociated.Fill(muon_isosumtrackpt_vtx3D_dtmuoncut_sipcut_associationrank_0->at(imuon)+muon_isosumtrackpt_vtx3D_dtmuoncut_sipcut_associationrank_1->at(imuon)+muon_isosumtrackpt_vtx3D_dtmuoncut_sipcut_unassociated->at(imuon));

          h_muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_associationrank_0.Fill(muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_associationrank_0->at(imuon));
          h_muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_associationrank_1.Fill(muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_associationrank_0->at(imuon)+muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_associationrank_1->at(imuon));
          h_muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_unassociated.Fill(muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_associationrank_0->at(imuon)+muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_associationrank_1->at(imuon)+muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_unassociated->at(imuon));

          h_muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_nodzcut_associationrank_0.Fill(muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_nodzcut_associationrank_0->at(imuon));
          h_muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_nodzcut_associationrank_1.Fill(muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_nodzcut_associationrank_0->at(imuon)+muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_nodzcut_associationrank_1->at(imuon));
          h_muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_nodzcut_unassociated.Fill(muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_nodzcut_associationrank_0->at(imuon)+muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_nodzcut_associationrank_1->at(imuon)+muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_nodzcut_unassociated->at(imuon));

          h_muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_sipcut_associationrank_0.Fill(muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_sipcut_associationrank_0->at(imuon));
          h_muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_sipcut_associationrank_1.Fill(muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_sipcut_associationrank_0->at(imuon)+muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_sipcut_associationrank_1->at(imuon));
          h_muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_sipcut_unassociated.Fill(muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_sipcut_associationrank_0->at(imuon)+muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_sipcut_associationrank_1->at(imuon)+muon_isosumtrackpt_vtx3D_hasdtmuon_dtmuoncut_sipcut_unassociated->at(imuon));
        }
  ...
  if (treeList.size()==2){
    ...
    {
      TString canvasname=Form("cCompare_muonabsiso_muon_%s_Vtx3D", strSelectionLower.Data());
      ...
      plotables.front().GetXaxis()->SetRangeUser(0, 0.3*xmultiplier);
    ...
    {
      TString canvasname=Form("cCompare_muon_%s_absiso_ROC", strSelectionLower.Data());
      TCanvas canvas(canvasname, "", 8, 30, 800, 800);
      canvas.cd();
      gStyle->SetOptStat(0);
      canvas.SetFillColor(0);
      ...
      plotables.emplace_back(gr_ROC_vtx3D_hasdtmuon_dtmuoncut_unassociated, "3D A, C and others (#Deltaz<0.1 cm, |t_{trk}-t_{#mu}|<3#delta#Deltat)");
      plotables.emplace_back(gr_ROC_vtx3D_dtmuoncut_unassociated, "3D A, C and others (#Deltaz<0.1 cm, no t_{trk} or |t_{trk}-t_{#mu}|<3#delta#Deltat)");
